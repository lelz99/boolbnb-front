        ...
        <template>
            <div class="col-sm-12 col-lg-6 col-xl-3 col-xl-2">
                <RouterLink :to="`/apartments/${apartment.slug}`">
                    ...
                    <div class="card card-apartment my-3">
                        <figure class="p-1">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">{{ apartment.title }}</h5>
                                <p class="d-flex align-items-center gap-1 apartment-address"><i class="fa-solid fa-location-dot"></i> {{ apartment.address }}</p>                     
                                <p v-show="apartment.distance" class="apartment-distance ms-3">{{ roundedDistance }} km</p>
                            <hr>
