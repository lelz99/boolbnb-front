  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <h4>BoolBnB</h4>
          <p>Rendi ogni viaggio memorabile con BoolBnB: Il tuo partner di fiducia in ogni destinazione.</p>
        </div>
        <div class="col-md-3">
      ...
      ></path>
        ...
        <div class="col-12">
            <address class="text-center">
                Copyright © 1996–2024 Boolbnb.com™. All rights reserved. <br>
                Boolbnb.com is part of BoolBnB Holdings Inc., the world leader in online travel and related services.
            </address>
        </div>
      </div>
    </div>
